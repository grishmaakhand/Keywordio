...
export default function FormForMedia() {
  const [isModalOpen, setModalOpen] = useState(false);

  const handleModalOpen = () => {
    setModalOpen(true);
    console.log("clccccccccccccc");
  };
  ...
  return (
    <div>
      <NestedModal open={isModalOpen} onClose={handleModalClose} />
      ...
      >
        ...
        <div className="flex flex-col md:flex-row justify-between w-full gap-5">
          ...
          />{" "}
          <InputFields
            heading="Portrait Marketing Image(1:9)"
            placeholder="Add the URL of the image you want to use for the ad"
          />{" "}
          <InputFields
        ...
        <InputFields
          heading="Video URL"
          placeholder="Add the URL of the Video  you want to use for add"
        />
        <div className="flex flex-col md:flex-row justify-between w-full gap-5 ">
          <InputFields
